...
const OneWayTripDatePicker = ({ handleFirstTripChange }) => {
	...
	const handleDateChange = (ranges) => {
		handleFirstTripChange('firstTripDateFrom', ranges.selection.startDate);
		handleFirstTripChange('firstTripDateTo', ranges.selection.endDate);
...
export default OneWayTripDatePicker;
